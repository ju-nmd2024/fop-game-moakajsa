...
function draw() {
  ...
  if (gameOver === false) {
    ...
    if (packageY > 900 && packageX > bagX - 50 && packageX < bagX + 50) {
      gameOver = true;
      resultScreenWin();
      console.log(" YOU WIN!");
...
function button() {
  mouseClicked(mouseX > 200 && mouseX < 400 && mouseY > 520 && mouseY < 590);
}
